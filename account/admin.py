...
from .models import CustomUser, UserRole, OTP, Template, Campaign, Message, Contact, ContactGroup, AccessToken, CredentialsManagement
...
admin.site.register(CredentialsManagement)
